...
# look up the preferred default reader class using the config. currently, this
# should be named JP2Reader and implemented
# in a directory with the name of the jp2_reader variable.
# for example, set jp2_reader = rasterio and implement JP2ImageReader in
# rasterio.py in this directory
RasterInterface = getattr(
    importlib.import_module(f'gim_cv.interfaces.jp2.{cfg.jp2_reader}'),
    'RasterInterface'
)
...
class ImageReader(RasterInterface, tm.Logged):
    def __init__(self, *args, **kwargs):
        ...
        self.use_cache = cfg.cache_jp2 and cfg.cache_input_image_arrays
...
class BinaryMaskReader(RasterInterface, tm.Logged):
    def __init__(self, *args, **kwargs):
        ...
        # set array caching policy
        self.use_cache = cfg.cache_jp2 and cfg.cache_input_binary_mask_arrays
        super().__init__(*args, **kwargs)
...
class LabelledMaskReader(RasterInterface, tm.Logged):
    def __init__(self, *args, **kwargs):
        ...
        # set array caching policy
        self.use_cache = cfg.cache_jp2 and cfg.cache_input_labelled_mask_arrays
        super().__init__(*args, **kwargs)
...
class ImageWriter(RasterInterface, tm.Logged):
    def __init__(self, *args, **kwargs):
        ...
        # set array caching policy
        self.use_cache = cfg.cache_jp2 and cfg.cache_output_image_arrays
        super().__init__(*args, **kwargs)
...
class BinaryMaskWriter(ImageWriter, tm.Logged):
    def __init__(self, *args, **kwargs):
        ...
        self.use_cache = cfg.cache_jp2 and cfg.cache_output_binary_mask_arrays
        super().__init__(*args, **kwargs)
...
class LabelledMaskWriter(ImageWriter, tm.Logged):
    def __init__(self, *args, **kwargs):
        ...
        self.use_cache = cfg.cache_jp2 and cfg.cache_output_labelled_mask_arrays
        super().__init__(*args, **kwargs)
